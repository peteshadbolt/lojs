...
# Try to import the compiled version of the permanent. If it's not available, define a python version
try: 
    print "Using fast Ryser"
    import permanent as perm
    permanent = perm.permanent
except ImportError:
    print "Using slow Ryser"
    def permanent(a):
...
def dict_to_vector():
    """ Convert a sparse state to a numpy vector """
    pass

class Component():
    """ Prototype for a component """
